...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 position-fixed top-0 start-0 h-100 justify-content-center" style="background-color:beige;">
            <ul style="font-size:15px; font-weight:400;" class="list-unstyled text-decoration-none py-5 mx-5 justify-content-center text-uppercase">
            <a href="index.php" class="text-decoration-none text-white"> <li class="bg-danger m-2 px-3 py-2 text-center rounded">Dashboard</li></a>
                <a href="categories.php" class="text-decoration-none text-white"><li class="bg-danger m-2 px-3 py-2 text-center rounded">Categories</li></a>
                ...
                <a href="" class="text-decoration-none text-white"><li class="bg-danger m-2 px-3 py-2 text-center rounded">Products</li></a>
                <a href="#" class="text-decoration-none text-white"><li class="bg-danger m-2 px-3 py-2 text-center rounded">Categories</li></a>
